...
const DataGridPagination = () => {
  ...
  const paginationInfo = props.pagination?.info
    ...
    : `${from} - ${to} arası,toplam ${totalRows}`;
  ...
  return (
    ...
    >
      <div className="flex items-center space-x-2 order-2 md:order-1 pb-2 md:pb-0">
        <div className="text-sm text-muted-foreground">Sayfa başına</div>
        <Select
      ...
      <div className="flex flex-wrap items-center gap-2 order-1 md:order-2 pt-2 md:pt-0">
